...
package org.opengroup.osdu.odatadms.model.validation;
...
public class DatasetRegistryValidationDoc {
  ...
  public static final String INVALID_DATASET_REGISTRY_SCHEMA_KIND = "Invalid schema kind for odatadms registry. Kind must be: '%s'";
