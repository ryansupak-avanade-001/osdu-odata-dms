...
public interface IDmsProvider {
    ...
    GetDatasetRetrievalInstructionsResponse getDatasetRetrievalInstructions(GetODataQueryRequest request) throws DmsException;

    // new retrieval
    default RetrievalInstructionsResponse getRetrievalInstructions(GetODataQueryRequest request)
            throws DmsException {
            return null;
    }
