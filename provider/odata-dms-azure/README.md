...
$ mvn clean package -pl provider/odatadms-azure -am

# run service
#
# Note: this assumes that the environment variables for running the service as outlined
#       above are already exported in your environment.
$ java -jar $(find provider/odatadms-azure/target/ -name '*-spring-boot.jar')
...
#       above are already exported in your environment.
$ (cd testing/odatadms-test-azure/ && mvn clean test)
```
